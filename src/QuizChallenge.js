...
const QuizChallenge = (props) => {
  ...
  if (answerCheck === 'right' || answerCheck === 'show' ) {
    ...
    <center>
      ...
      <ProgressCircle correctCount={answerArray.correctCount} wrongCount={answerArray.wrongCount}/>
      <br></br>
  ...
  return (
    <center>
    <Scores correctCount={answerArray.correctCount} wrongCount={answerArray.wrongCount} mode='challenge' />
    <ProgressCircle correctCount={answerArray.correctCount} wrongCount={answerArray.wrongCount}/>
    <div style={{width: "50%"}}>
    <ThemeProvider theme={theme}>
